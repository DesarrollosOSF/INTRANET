...
if (!isset($data['inscripcion_id']) || !isset($data['material_id'])) {
...
try {
    ...
    ");
    $stmt->execute([$inscripcion_id, $material_id]);
    ...
    // Marcar curso como completado si todos los materiales están completados
    ...
    echo json_encode(['error' => 'Error al completar material']);
}
